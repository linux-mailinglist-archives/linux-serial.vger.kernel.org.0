...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6D23D1DE719
	for <lists+linux-serial@lfdr.de>; Fri, 22 May 2020 14:42:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728495AbgEVMmL (ORCPT <rfc822;lists+linux-serial@lfdr.de>);
        Fri, 22 May 2020 08:42:11 -0400
Received: from mail26.static.mailgun.info ([104.130.122.26]:11495 "EHLO
        mail26.static.mailgun.info" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728878AbgEVMmK (ORCPT
        <rfc822;linux-serial@vger.kernel.org>);
        Fri, 22 May 2020 08:42:10 -0400
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1590151329; h=Content-Transfer-Encoding: Content-Type:
 In-Reply-To: MIME-Version: Date: Message-ID: References: Cc: To:
 Subject: From: Sender; bh=Qsj3XdFkSYlyngdqyilJnAqg322hfJA4Oy1tuWIOrkY=;
 b=EjDpkmz/1ocWxhPeHsIu745MmMVXkz0NIH0smqj8YwC26xyY70Ek75au905D6CyXrxzdtB6/
 KTRMvJ+2inW85cH1Sxeo/zCtdNq8UwCj4xe3RtsMHmuB/WOS7PQIkHo2DL5PCrYZXCmnV/o7
 XpJkEkpnX4GQxSO6VV3NyWF8FB0=
X-Mailgun-Sending-Ip: 104.130.122.26
X-Mailgun-Sid: WyIzZmY0MiIsICJsaW51eC1zZXJpYWxAdmdlci5rZXJuZWwub3JnIiwgImJlOWU0YSJd
Received: from smtp.codeaurora.org (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171])
 by mxa.mailgun.org with ESMTP id 5ec7c890.7fbd7ad5b490-smtp-out-n02;
 Fri, 22 May 2020 12:41:52 -0000 (UTC)
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id C9411C433CA; Fri, 22 May 2020 12:41:52 +0000 (UTC)
...
Received: from [192.168.0.4] (unknown [124.123.29.106])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id 938EEC433C8;
        Fri, 22 May 2020 12:41:48 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 smtp.codeaurora.org 938EEC433C8
...
References: <20200519120704.9675-1-msavaliy@codeaurora.org>
 <20200519135056.GA487173@kroah.com>
Message-ID: <aa53d9ac-368d-2c56-efcd-205edebc96fa@codeaurora.org>
Date:   Fri, 22 May 2020 18:11:38 +0530
User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64; rv:68.0) Gecko/20100101
 Thunderbird/68.8.0
MIME-Version: 1.0
In-Reply-To: <20200519135056.GA487173@kroah.com>
...
On 5/19/2020 7:20 PM, Greg KH wrote:
...
It needs register reads to decide QUP version and that address we can't 
get unless  DTSI comesup after probe OR passed from cmdline.

cmdline is not good option IMO : we need to pass one more address and 
that varies between hardware.

Also DTSI read is not available till driver probe happens.

> How can you build a kernel for both types of hardware and expect the
> same image to work on both?

Based on config only we can make it working as hardwares are different. 
we dont have dtsi option for earlyconsole.

same image can't work on both hardware as HW address to read version varies.
...
Done,  it didn't gave any warning or error.
...
Only option is kernel command line passing one more address, but it will 
change per hardware chip, prone to the error.

DT is not available in the earlyconsole time. we need logs from the time 
kernel starts.
...
> call away?
Added to ensure wrtes over NOC went through, but we have _relaxed calls 
so i think we can remove readl.
> thanks,
>
> greg k-h
