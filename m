...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CBF1F6F3A7
	for <lists+linux-serial@lfdr.de>; Sun, 21 Jul 2019 16:27:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726431AbfGUO1G (ORCPT <rfc822;lists+linux-serial@lfdr.de>);
        Sun, 21 Jul 2019 10:27:06 -0400
Received: from mga07.intel.com ([134.134.136.100]:16278 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726405AbfGUO1F (ORCPT <rfc822;linux-serial@vger.kernel.org>);
        Sun, 21 Jul 2019 10:27:05 -0400
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga105.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 21 Jul 2019 07:27:03 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.64,291,1559545200"; 
   d="scan'208";a="176764414"
Received: from black.fi.intel.com ([10.237.72.28])
  by FMSMGA003.fm.intel.com with ESMTP; 21 Jul 2019 07:27:01 -0700
Received: by black.fi.intel.com (Postfix, from userid 1003)
        id 8F2DB81; Sun, 21 Jul 2019 17:27:00 +0300 (EEST)
...
Subject: [PATCH v3] serial: 8250_exar: Move the Exar bits out from 8250_port
Date:   Sun, 21 Jul 2019 17:26:59 +0300
Message-Id: <20190721142659.60773-1-andriy.shevchenko@linux.intel.com>
...
@@ -496,8 +554,7 @@ exar_pci_probe(struct pci_dev *pcidev, const struct pci_device_id *ent)
 		return rc;
...
-
 ...
 static unsigned int npcm_get_divisor(struct uart_8250_port *up,
 		unsigned int baud)
@@ -2497,8 +2434,6 @@ static unsigned int serial8250_do_get_divisor(struct uart_port *port,
...
@@ -2585,13 +2520,6 @@ void serial8250_do_set_divisor(struct uart_port *port, unsigned int baud,
