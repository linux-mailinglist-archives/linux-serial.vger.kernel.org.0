Return-Path: <linux-serial+bounces-12478-lists+linux-serial=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-serial@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SEBjHi/db2n8RwAAu9opvQ
	(envelope-from <linux-serial+bounces-12478-lists+linux-serial=lfdr.de@vger.kernel.org>)
	for <lists+linux-serial@lfdr.de>; Tue, 20 Jan 2026 20:53:19 +0100
X-Original-To: lists+linux-serial@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [IPv6:2605:f480:58:1:0:1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id C060E4AD0E
	for <lists+linux-serial@lfdr.de>; Tue, 20 Jan 2026 20:53:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 6E886A4242D
	for <lists+linux-serial@lfdr.de>; Tue, 20 Jan 2026 17:34:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 438E5426D11;
...
X-Spamd-Result: default: False [1.54 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-12478-lists,linux-serial=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[fabrizio.castro.jz@renesas.com,linux-serial@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[das.au:url,renesas.com:email,renesas.com:dkim,dfw.mirrors.kernel.org:rdns,dfw.mirrors.kernel.org:helo,glider.be:email,linuxfoundation.org:email]
X-Rspamd-Queue-Id: C060E4AD0E
